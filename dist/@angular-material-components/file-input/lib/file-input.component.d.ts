...
export declare class NgxMatFileInputComponent implements MatFormFieldControl<FileOrArrayFile>, OnDestroy, DoCheck, ControlValueAccessor {
    ...
    placeholder: string;
    separator: import("@angular/core").InputSignal<string>;
